...
jrs_path = '/Users/mengfei/git_repo/armour/kinova_src/kinova_simulator_interfaces/kinova_planner_realtime_armtd_comparison/offline_jrs/orig_parameterization/'; % where the jrss are stored
...
for j = 1:length(dq)
    ...
    % create poly zonos from JRS 100
    for i = 1:length(jrs_load)
...
save('Q_err.mat',"Q","Qd","Qd_a","Qdd_a")
