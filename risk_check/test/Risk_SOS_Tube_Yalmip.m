...
Safe_1= @(x1,x2,x3,t) safe_1(x1,x2,x3,t)*100000; % C * A_SOS_Cons_1>=0 where C=100000
...
parfor i=1:50
status_1=func_3D_SOS_Tube_yalmip(Safe_1,Px,Py,Pz,t0,tf,R,d);
status_2=func_3D_SOS_Tube_yalmip(Safe_2,Px,Py,Pz,t0,tf,R,d);
clc; 
