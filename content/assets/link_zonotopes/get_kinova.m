...
for i = 1:n_bodies+1
    ...
    % mesh_name = strrep(strrep(strrep(mesh_path,'/Users/mengfei/mengfei_code/RDF/environments/robots/assets/robots/kinova_arm/',''),'.stl',''),'_',' ');
    ...
    filename = sprintf('kinova_link_zonotope_%i.mat', i-1);
